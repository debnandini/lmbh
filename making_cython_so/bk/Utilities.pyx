...
ctypedef extern from "Utilities.h":
	struct wavefilt:
		int ncof,ioff,joff
		double *cc,*cr

cdef extern from "ConstSpec.h":
	float TSUN=4.92569043916e-6
	float PI=3.1415926535897931159979634685442
	float PI2=9.869604401089357992304940125905
	float TPI=6.2831853071795862319959269370884
	float RT2PI=2.5066282746310005024
	float RTPI=1.772453850905516
	float RT2=1.414213562373095
	float IRT2=0.707106781186547549
	float TRT2=2.8284271247461901
	float LN2=0.6931471805599453
	float MSUN_SI=1.988546954961461467461011951140572744e30
	float Qs=8.0
	float Qprint=8.0
	float fsp=8.0
	int spline=0
