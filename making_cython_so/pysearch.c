...
static PyObject *__pyx_pf_8pysearch_py_main_gut(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_st, int __pyx_v_se); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_8pysearch_1py_main_gut(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8pysearch_1py_main_gut = {"py_main_gut", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8pysearch_1py_main_gut, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8pysearch_1py_main_gut(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_st;
  int __pyx_v_se;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_st,&__pyx_n_s_se,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_se)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_st = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_st == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_se = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_se == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_8pysearch_py_main_gut(__pyx_self, __pyx_v_st, __pyx_v_se);
...
static PyObject *__pyx_pf_8pysearch_py_main_gut(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_st, int __pyx_v_se) {
 ...
 * 	main_gut(st, se)             # <<<<<<<<<<<<<<
 */
  (void)(main_gut(__pyx_v_st, __pyx_v_se));
 ...
 * 	main_gut(st, se)
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_n_s_st, __pyx_n_s_se); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 4, __pyx_L1_error)
